...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'soporte@mail.com'; //correo
            $mail->Password = 'xxx xxxx xxxx xxxx';   //contraseña de aplicación
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            $mail->setFrom('soporte@mail.com', 'cloudSostenible');
            $mail->addAddress('soporte@mail.com'); // administrador
